...
# Funktsioon peaks algama algse saldoga ja võimaldama teha operatsioone: deposiit (raha lisamine) ja 
# väljavõte (raha eemaldamine). Tagastage peale igat toimingut konto jääk.
...
# Kirjutage selge dokumentatsioon, mis kirjeldab, kuidas algset saldot seada, kuidas toiminguid teostada ja millist tüüpi 
# väärtusi tagastatakse.



def konto_haldur(tehing, raha, saldo):
    """
    Lisa või eemalda summa pangakontolt.
