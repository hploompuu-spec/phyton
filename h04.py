...
#ALT ja 3 lisab trellid kogu teksti ette
# 
...
a = int(input("Lisa külg 1: ")) #int käsuga muudan vastuse täisarvuks
b = int(input("Lisa külg 2: "))

p = (a+b)*2

print(f"Aia kogupikkus on {p}.") #print(f"") lubab lisada muutujad otse teksti sisse, kasutades loogilisi sulge {}
