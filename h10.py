# Arvude keskmine
# Koostage Pythoni programm, mis küsib kasutajalt arve ükshaaval. Programm peaks jätkama arvude küsimist ja nende vastuvõtmist seni,
...
while loop:
    arv = input("Lisa arv:")
    if arv == "": #kui midagi ei sisesta, katkestatakse pärimine
